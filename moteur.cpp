 ...
 * Constructeur
 */
Moteur::Moteur(uint8_t pwm_pin, uint8_t brake_pin, uint8_t walk_pin, uint8_t U_pin, uint8_t V_pin)
{
 ...
 */
moteur_state_t Moteur::getMoteurState()
{
 ...
 */
void Moteur::setMoteurState(moteur_state_t state)
{
  _moteur_state = state;
  switch (state)
  {
 ...
 */
uint8_t Moteur::getConsigneGachette()
{
  return _consigne;
}
 ...
 */
void Moteur::setConsigneGachette(uint8_t cg)
{
  _consigne = cg;
}
...
void Moteur::ralentir(uint8_t moins)
{
...
void Moteur::accelerer(uint8_t plus)
{
...
void Moteur::augmenterConsigne(uint8_t plus)
{
...
uint8_t Moteur::getUPin()
{
  return _hall_U_pin;
}

uint8_t Moteur::getVPin()
{
  return _hall_V_pin;
}

void Moteur::calculerVitesse()
{
 ...
 */
void Moteur::mettreLesGaz(double consigneVitesse)
{
