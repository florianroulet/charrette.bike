...
#include "Arduino.h"
#ifndef RemorqueLed_h
#define RemorqueLed_h
...
{
  public:
    RemorqueLed(float maxTraction, float seuilTractionNulle, float pwmMin, float pwmMax);
    ...
    float _pwmMax;
  private:
    int _mode = 0;	//mode = 0  --> normal, mode = 1 --> walk
